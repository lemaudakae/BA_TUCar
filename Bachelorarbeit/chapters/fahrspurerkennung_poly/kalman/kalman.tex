...
\centering
\subfloat[Iteration n\label{fig:evaluation:kalman:weggezogen:1}]{\includegraphics[width=0.45\textwidth]{evaluation_kalman_weggezogen_1}}
\hfill
\subfloat[Iteration n+1\label{fig:evaluation:kalman:weggezogen:2}]{\includegraphics[width=0.45\textwidth]{evaluation_kalman_weggezogen_2}}
\hfill
\subfloat[Iteration n+2\label{fig:evaluation:kalman:weggezogen:3}]{\includegraphics[width=0.45\textwidth]{evaluation_kalman_weggezogen_3}}
\hfill
\subfloat[Iteration n+3\label{fig:evaluation:kalman:weggezogen:4}]{\includegraphics[width=0.45\textwidth]{evaluation_kalman_weggezogen_4}}
\hfill
