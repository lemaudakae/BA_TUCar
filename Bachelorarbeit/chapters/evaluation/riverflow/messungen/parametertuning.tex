...
\begin{figure}[htbp] % [htb]
\centering
\subfloat[Boxplot ohne Startphase\label{fig:evaluation:riverflow:times_pic_3Hz_0_2m_s_boxplot}]{\includegraphics[scale=\mtlstscale]{evaluation_riverflow_times_pic_3Hz_0_2m_s_boxplot}}
\hfill	
