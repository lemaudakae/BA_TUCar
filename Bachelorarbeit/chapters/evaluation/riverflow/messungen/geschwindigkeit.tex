...
\begin{figure}[htbp] % [htb]
	\centering
	\subfloat[][]{\includegraphics[width=0.35\textwidth]{evaluation_riverflow_regelungspunkte_je_linie_0_2m_s_3Hz.pdf}}	
	\quad
	\subfloat[][]{\includegraphics[width=0.55\textwidth]{evaluation_riverflow_regelungspunkte_je_geschw_3Hz.pdf}}
