...
\begin{figure}[htbp] % [htb]
  \centering  
  \subfloat[][]{\includegraphics[width=0.45\textwidth]{grundlagen_hough_datenraum.png}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.45\textwidth]{grundlagen_hough_modellraum.png}}  
