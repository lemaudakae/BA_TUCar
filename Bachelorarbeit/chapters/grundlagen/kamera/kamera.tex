...
\end{figure}
 Die Verschiebung des Bildmittelpunktes (Koordinatenursprungs) von \gls{lat:OSKOS} zu \gls{lat:OSKOSR} \vct{\gls{lat:Translationsvektor}^{\gls{lat:OSKOSR}}_{\gls{lat:OSKOS}}} sowie die Parameter \scl{c},\scl{d},\scl{e} werden im Kalibrationsprozess durch die Toolbox ermittelt.
