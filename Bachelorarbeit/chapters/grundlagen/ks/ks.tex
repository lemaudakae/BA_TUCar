...
\( \pnt{p}_{\gls{lat:AllgKOS}_2} = \gls{lat:Transformationsmatrix}_{\gls{lat:AllgKOS}_2\gls{lat:AllgKOS}_1} \cdot  \pnt{p}_{\gls{lat:AllgKOS}_1} \) gilt, heißt homogene Transformationsmatrix und wird folgendermaßen aufgestellt:
