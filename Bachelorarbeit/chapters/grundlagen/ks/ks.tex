...
Mathematisch lassen sich der Translationsvektor \gls{lat:Translationsvektor} und die Rotationsmatrix \gls{lat:Rotationsmatrix} wie folgt darstellen \autocite[S.~26f]{corkeRoboticsVisionControl2017}.
...
Die Matrix \gls{lat:Transformationsmatrix}, welche die Punkte \pnt{p} transformiert, heißt homogene Transformationsmatrix und wird folgendermaßen aufgestellt:
...
%Den zu transformierenden Punkten muss dazu noch eine Zeile mit einer \(1\) hinzugefügt werden, damit die Dimensionen für die Multiplikation zueinander passen. 
