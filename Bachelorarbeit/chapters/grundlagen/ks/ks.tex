\section{Koordinatensysteme} \label{sec:ks}
...
Die Pose bezeichnet den Zustandsvektor aus Position und Orientierung des Fahrzeugs in der Welt (siehe Gleichung~\ref{eq:regelung_prinzip_pose}). Deren Lage bezeichnet das Roboterkoordinatensystem \gls{lat:RoboterKOS}, welches in der Hinterachse des Autos festgelegt ist. 
