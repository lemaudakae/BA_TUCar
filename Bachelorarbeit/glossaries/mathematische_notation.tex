...
sort=math_2v_norm, type=mathlist
}
...
\newglossaryentry{math:KSpunkt}{
	...
	description={Hochgestellte kalligrafische Großbuchstaben bezeichnen das Koordinatensystem, auf das sich der Vektor bezieht},
