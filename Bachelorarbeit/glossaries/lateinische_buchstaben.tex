...
\newglossaryentry{lat:zp}{
	name=\vct{q},
	description={Zielpunkt für den \glqq Pure-Pursuit\grqq -Regler},
	sort=lat_2p_q, type=latlist
}
\newglossaryentry{lat:mp}{
	name=\vct{m},
	description={Mittelpunkt eines Kreises},
	sort=lat_2p_m, type=latlist
}
\newglossaryentry{lat:rad}{
	name=\scl{r},
	description={Radius eines Kreises},
	sort=lat_1s_r, type=latlist
}
\newglossaryentry{lat:av}{
	name=\vct{a},
	description={Abstandsvektor},
	sort=lat_3v_a, type=latlist
}
...
\newglossaryentry{lat:Skalierungsmatrix}{
	name=\mtx{S},
	description={Skalierungsmatrix},
	sort=lat_4m_s, type=latlist
}
...
description={Roboter-/Bodykoordinatensystem},
sort=lat_5k_r, type=latlist
}
\newglossaryentry{lat:BildKOS}{
name=\ensuremath{\mathcal{I}},
description={Bild-/Imagekoordinatensystem},
...
\newglossaryentry{lat:CamKOS}{ %lat:OCKOS
name=\ensuremath{\mathcal{C}},
description={Kamerakoordinatensystem},
sort=lat_5k_oc, type=latlist
}
\newglossaryentry{lat:OSKOS}{
name=\ensuremath{\mathcal{S}},
description={ideales Bildsensorkoordinatensystem der \gls{acr:ocamcalib}-Toolbox},
sort=lat_5k_os, type=latlist
}
\newglossaryentry{lat:OSKOSR}{
name=\ensuremath{\mathcal{S'}},
description={reales Bildsensorkoordinatensystem der \gls{acr:ocamcalib}-Toolbox},
...
name=\scl{w},
description={Radstand (mittlerer Abstand zwischen Vorder-und Hinterachse des Fahrzeugs)},
sort=lat_1s_l, type=latlist
}
% Geraden
\newglossaryentry{lat:achsenabschnitt}{
	name=\scl{n},
	description={Achsenabschnitt einer Gerade (\gls{y}-Wert bei \gls{x} = 0)},
	sort=lat_1s_n, type=latlist
}
\newglossaryentry{lat:anstieg}{
	name=\scl{m},
	description={Anstieg einer Gerade (d\gls{y}/d\gls{x})},
	sort=lat_1s_m, type=latlist
}
