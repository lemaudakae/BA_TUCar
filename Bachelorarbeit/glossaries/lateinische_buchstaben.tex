...
name=\scl{y_{off}},
description={Lateraler Versatz: Abstand der Fahrspurmitte vom Koordinatenursprung des Linien-\gls{acr:ks} \gls{lat:LinienKOS}},
...
description={Kamera-\gls{acr:ks}},
sort=lat_5k_oc, type=latlist
}
\newglossaryentry{lat:OSKOS}{
name=\ensuremath{\mathcal{S}},
description={ideales Bildsensor-\gls{acr:ks} der \gls{acr:ocamcalib}-Toolbox},
sort=lat_5k_os, type=latlist
}
\newglossaryentry{lat:OSKOSR}{
name=\ensuremath{\mathcal{S'}},
description={reales Bildsensor-\gls{acr:ks} der \gls{acr:ocamcalib}-Toolbox},
